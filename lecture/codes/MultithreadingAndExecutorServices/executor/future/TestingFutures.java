package lecture.codes.MultithreadingAndExecutorServices.executor.future;
...
public class TestingFutures {
    static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        FetchName task1 = new FetchName("Oggy");
        FetchName task2 = new FetchName("Jack");
        FetchName task3 = new FetchName("Bob");
        FetchName task4 = new FetchName("Olivia");
